# File Title: QR Code
# Feature: Create and customize a QR code when input a website link.
# How To Run:
# 0.5 (if using pyCharm): make sure the project's interpreter is python 3.x.x (without the name of the project).
# e.g. Yes if it's Python 3.13, No if it's Python 3.13 (miniCodes).
# 1. Download the libraries using the command: pip install qrcode pillow
# Run the file
# Source/Credit/More information about the library: https://github.com/lincolnloop/python-qrcode/blob/main/README.rst
...
print("___QR CODE GENERATOR___")
website_link = input("Input the link: ")
file_name = input("Input filename to save to: ")
